...
def send_forget_password_mail(email , token, domain, ssl ):
    ...
    subject = 'Reset Password akun SIPEL LPPMEL'
    message = f" "
      ...
      bgcolor="#E3EEFE">
        <tbody>
          <tr>
            ...
            Kami menerima permintaan reset password akun SIPEL LPPMEL anda
          </span><p style="color:#00204A;font-size:14px;line-height:24px;">
            Jika Anda tidak membuat permintaan ini, abaikan saja email ini. Jika tidak, silakan klik tombol di bawah ini untuk reset password akun SIPEL LPPMEL anda.
          </p>
            ...
            <a href="{link}" style="display:block; padding:15px 25px; background-color:#448EF6; color:#ffffff; border-radius:7px; text-decoration:none;">Reset Password akun SIPEL LPPMEL</a>
          </span>
...
def send_verif_mail(email , token, domain, ssl ):
    ...
    host = socket.gethostname()
    subject = 'Verifikasi akun SIPEL UEM'
    message = f" "
        ...
        <tbody>
          <tr>
            ...
            Verifikasi Email
                                  ...
                                  <tr>
                                    <td align="center"> <span style="color:#00204A;font-size:14px;line-height:24px;">
            Kami menerima permintaan verifikasi akun SIPEL LPPMEL anda
          </span><p style="color:#00204A;font-size:14px;line-height:24px;">
            Jika Anda tidak membuat permintaan ini, abaikan saja email ini. Jika tidak, silakan klik tombol di bawah ini untuk verifikasi akun SIPEL LPPMEL anda.
          </p>
